package com.his.nurse.widget.jazzylistview;
...
import com.his.nurse.widget.jazzylistview.effect.CardsEffect;
import com.his.nurse.widget.jazzylistview.effect.CurlEffect;
import com.his.nurse.widget.jazzylistview.effect.FadeEffect;
import com.his.nurse.widget.jazzylistview.effect.FanEffect;
import com.his.nurse.widget.jazzylistview.effect.FlipEffect;
import com.his.nurse.widget.jazzylistview.effect.FlyEffect;
import com.his.nurse.widget.jazzylistview.effect.GrowEffect;
import com.his.nurse.widget.jazzylistview.effect.HelixEffect;
import com.his.nurse.widget.jazzylistview.effect.ReverseFlyEffect;
import com.his.nurse.widget.jazzylistview.effect.SlideInEffect;
import com.his.nurse.widget.jazzylistview.effect.StandardEffect;
import com.his.nurse.widget.jazzylistview.effect.TiltEffect;
import com.his.nurse.widget.jazzylistview.effect.TwirlEffect;
import com.his.nurse.widget.jazzylistview.effect.WaveEffect;
import com.his.nurse.widget.jazzylistview.effect.ZipperEffect;
...
public class JazzyHelper implements AbsListView.OnScrollListener {
	...
	public JazzyHelper(Context context, AttributeSet attrs) {
		...
		int transitionEffect = a.getInteger(R.styleable.JazzyListView_effect,
				STANDARD);
		int maxVelocity = a.getInteger(R.styleable.JazzyListView_max_velocity,
				MAX_VELOCITY_OFF);
		mOnlyAnimateNewItems = a.getBoolean(
				R.styleable.JazzyListView_only_animate_new_items, false);
		mOnlyAnimateOnFling = a.getBoolean(
				R.styleable.JazzyListView_max_velocity, false);
		mSimulateGridWithList = a.getBoolean(
				R.styleable.JazzyListView_simulate_grid_with_list, false);
		a.recycle();
	...
	public final void onScroll(AbsListView view, int firstVisibleItem,
		...
		if (mIsScrolling && shouldAnimateItems) {
			...
			while (lastVisibleItem - indexBeforeLast > mLastVisibleItem) {
				View item = view.getChildAt(lastVisibleItem - firstVisibleItem
						- indexBeforeLast);
